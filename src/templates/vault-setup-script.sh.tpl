...
ARGO_WF_DB_USER="argo_workflow"
ARGO_WF_POSTGRES_PASSWORD=$(randpw)
ARGO_CD_WFREPO_USER="{{ .ArgoCdWFRepoUser}}"
ARGO_CD_WFREPO_SSH_PRIVATE_KEY="{{ .ArgoCdWFRepoSSHPrivateKey }}"
KEYCLOAK_DB_PASSWORD="{{ .KeycloakDBPassword }}"
KEYCLOAK_CLIENT_SECRET_GRAFANA="{{ .KeycloakClientSecretGrafana }}"
KEYCLOAK_CLIENT_SECRET_VAULT="${CLIENT_SECRET}"
KEYCLOAK_CLIENT_SECRET_ARGO_WF="{{ .KeycloakClientSecretArgoWf }}"
KEYCLOAK_PROVIDER_SECRET_OPENSHIFT="{{ .KeycloakProviderSecretOCP }}"
